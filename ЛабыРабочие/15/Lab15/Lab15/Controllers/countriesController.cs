...
namespace Lab15.Controllers
{
    public class countriesController : ApiController
    {
        ...
        // GET: api/continents
        public IQueryable<country1> Getcontinents()
        {
            return db.countries;
        }

        // GET: api/continents/5
        [ResponseType(typeof(country1))]
        public async Task<IHttpActionResult> Getcontinent(int id)
        {
            country1 continent = await db.countries.FindAsync(id);
            if (continent == null)
            {
                return NotFound();
            }
        ...
        public async Task<IHttpActionResult> Putcontinent(int id, country1 continent)
        {
        ...
        // POST: api/continents
        [ResponseType(typeof(country1))]
        public async Task<IHttpActionResult> Postcontinent(country1 continent)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
