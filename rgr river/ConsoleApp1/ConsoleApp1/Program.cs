...
namespace ConsoleApp1
{
    class Program
    {
        static void Main(string[] args)
        {
			...
			fileDownloader.DownloadFile("https://drive.google.com/uc?id=1jeBgnobgNnYaKjqjj_YelN8RhsFFQtCi&export=download", @"C:\Users\serej\source\repos\ConsoleApp1\ConsoleApp1\test2.txt");
