...
using InsuranceClassLibrary.Serialization;
    ...
    public partial class FormMain : Form
    {
        ...
        private void XmlSaveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialogMain.ShowDialog() == DialogResult.OK)
            {
                ...
                IncuranceSerialization.Save(saveFileDialogMain.FileName, SerializeType.XML);
            }
        }
        ...
        private void JsonSaveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialogMain.ShowDialog() == DialogResult.OK)
            {
                IncuranceSerialization.Save(saveFileDialogMain.FileName, SerializeType.JSON);
            }
        }
        ...
        private void BinSaveToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (saveFileDialogMain.ShowDialog() == DialogResult.OK)
            {
                IncuranceSerialization.Save(saveFileDialogMain.FileName, SerializeType.Binary);
            }
        }

        private void XmlLoadToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            openFileDialog.Filter = "XML-файлы|*.xml|Все файлы|*.*";
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                IncuranceSerialization.Load(openFileDialog.FileName, SerializeType.XML);

            }
        }

        private void JsonLoadToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            openFileDialog.Filter = "JSON-файлы|*.json|Все файлы|*.*";
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                IncuranceSerialization.Load(openFileDialog.FileName, SerializeType.JSON);
            }
        }

        private void BinloadToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            openFileDialog.Filter = "Двоичные файлы|*.bin|Все файлы|*.*";
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                IncuranceSerialization.Load(openFileDialog.FileName, SerializeType.Binary);
            }
        }
    }
}
